...
import { CopilotAuthForm, type CopilotCredential } from "./copilotAuthForm";
...
interface Props {
	...
	onCopilotAuthorized?: (credential: CopilotCredential) => Promise<void>;
			...
			{!isAzure && !isBedrock && !isBedrockMantle && !isVertex && !isDatabricks && (!isGithubCopilot || legacyCopilotApp) && (
				<FormField
					...
					render={({ field }) => (
						<FormItem>
							<FormLabel>
								{isGithubCopilot ? "GitHub Copilot Token" : "API Key"} {isVLLM || isGithubCopilot ? "(Optional)" : ""}
							</FormLabel>
							{isGithubCopilot && (
								<FormDescription>
